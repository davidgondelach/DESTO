...
function mainDensityEstimationTLEFnc(yr,mth,dy,nofDays,ROMmodel,r,selectedObjects,SUPERCLOUD,varargin)
...
if SUPERCLOUD
    ...
    spicePath = fullfile('/Users','davidgondelach','Documents','mice');
    resultsDirPath = ['/Users/davidgondelach/Google Drive/PostDoc/DensityEstimation/',ROMmodel,'/'];
end
